...
int main(int argc,char*argv[])
{
	...
	printf("Enter the output width and height :");
	scanf("%d%d",&owidth,&oheight);
	
  	IplImage * imgfinal= cvCreateImage(cvSize(owidth,oheight),IPL_DEPTH_8U,img->nChannels);
  	
  	
  	pde(img,imgfinal,owidth,oheight);
  	  // show the image
